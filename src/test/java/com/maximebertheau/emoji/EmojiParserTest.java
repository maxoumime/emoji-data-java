...
//        assertNull(candidates.get(0).skinVariationType);
//    }
//
//    @Test
...
//        assertNull(candidates.get(1).skinVariationType);
//    }
//
//    @Test
...
//        assertEquals(1, candidates.size());
//        assertEquals("candidate", candidates.get(0).alias);
//        assertEquals(SkinVariationType.TYPE_3, candidates.get(0).skinVariationType);
//    }
//
//    @Test
...
//        // GIVEN
//        String str = "Let's test the :family: emoji and " +
